...
const items = [
  ...
  },
  {
    ...
    imageLight: `url(https://res.cloudinary.com/djqhpdau5/image/upload/v1738444342/Platforms_uf6o7f.png)`,
  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: '100%', md: '60%' } }}>
        ...
        >
          The days of depending on word of mouth to know what's happening is over. LopesEvents brings everybody together in a 
          convenient and user friendly way.
        </Typography>
      </Box>
      <Box
        sx={{
